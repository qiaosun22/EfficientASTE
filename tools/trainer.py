    ...
    def train(self):
        for i in range(self.args.epochs):
            ...
            for j in trange(self.trainset.batch_count):
                self.model.train()
                sentence_ids, bert_tokens, masks, word_spans, tagging_matrices, tokenized = self.trainset.get_batch(j)
                ...
                logits, logits1, sim_matrix = self.model(bert_tokens, masks)
                ...
                loss = loss0 + loss1 + 1e-12 * loss_cl
